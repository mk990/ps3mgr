...
func TestLoadDefaultsAndEnvironment(t *testing.T) {
	...
	if cfg.PS3GameDir != "." || cfg.Listen != "127.0.0.1:8080" || cfg.RemoteGameDir != "/dev_hdd0/GAMES" || cfg.PS2FPKGEmulator != "./PS22PS4-GUI/bin/emulators/JakV2.pkg" || cfg.PS4GameDir != "./ps4-games" || cfg.PS4RemoteGameDir != "/user/app" || cfg.PS4RPIPort != 12800 || cfg.PS4PKGListen != "0.0.0.0:8081" || cfg.PS4AdvertiseURL != "" || cfg.PS4RPITimeout != 30*time.Second || cfg.PS5GameDir != "./ps5-games" || cfg.PS5RemoteGameDir != "/data/etaHEN/games" || cfg.PS5FTPPort != 2121 || cfg.ScanTimeout != 500*time.Millisecond || !cfg.PS2CoverDownload {
	...
	t.Setenv("PS3MGR_PS2_FPKG_EMULATOR", "/fpkg/emulator.pkg")
